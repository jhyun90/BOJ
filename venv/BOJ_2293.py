...
for i in range(len(coin)):
    ...
    for j in range(coin[i], k + 1):
        print("dp[{}] (경우의 수: {}) + dp[{}] (경우의 수: {}) =".format(j, dp[j], j - coin[i], dp[j - coin[i]]), end=' ')
        dp[j] += dp[j - coin[i]]
        print("dp[{}] (경우의 수: {})".format(j, dp[j]))
...
8   (1)     8   (1)     2 * 4       8   (0)     3 * 0
9   (1)     9   (0)     2 * 0       9   (1)     3 * 3
10  (1)     10  (1)     2 * 5       10  (0)     3 * 0
11  (1)     11  (0)     2 * 0       11  (0)     3 * 0
...
10  (10)    (1 * 10 + 2 * 0) + 5 * 0  (1 * 8 + 2 * 1) + 5 * 0   (1 * 6 + 2 * 2) + 5 * 0   (1 * 4 + 2 * 3) + 5 * 0   (1 * 2 * 2 * 4) + 5 * 0   (1 * 0 + 2 * 5) + 5 * 0   (1 * 5 + 2 * 0) + 5 * 1   (1 * 3 + 2 * 1) + 5 * 1   (1 * 1 + 2 * 2) + 5 * 1   (1 * 0 + 2 * 0) + 5 * 2
...
dp[4] 1 + dp[2] 2 = dp[4] 3
dp[5] 1 + dp[3] 2 = dp[5] 3
dp[6] 1 + dp[4] 3 = dp[6] 4
dp[7] 1 + dp[5] 3 = dp[7] 4
dp[8] 1 + dp[6] 4 = dp[8] 5
dp[9] 1 + dp[7] 4 = dp[9] 5
