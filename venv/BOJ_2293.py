...
3   (2)     3(-> 1을 사용하여 합이 3이 되는 경우의 수: 1) + 2 * 0        0(-> 1을 사용하여 합이 0이 되는 경우의 수: 1) + 2 * 1
...
11  (11)    10(-> 1과 2를 사용하여 합이 10이 되는 경우의 수: 6) + 5 * 0   6(-> 1과 2를 사용하여 합이 6이 되는 경우의 수: 4) + 5 * 1   1(1과 2를 사용하여 합이 1이 되는 경우의 수: 1) + 5 * 2
12  (12)    10(-> 1과 2를 사용하여 합이 10이 되는 경우의 수: 6) + 5 * 0   7(-> 1과 2를 사용하여 합이 7이 되는 경우의 수: 4) + 5 * 1   2(1과 2를 사용하여 합이 2가 되는 경우의 수: 2) + 5 * 2
'''
